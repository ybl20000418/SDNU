	...
	<div class="top2">
		...
		<div class="fr top-link">
			<a target="mainCont" title="DeathGhost"><i
				class="adminIcon"></i><span>用户：201701</span></a> 
		</div>
	</div>
		...
		<div class="div1">
           ...
           <div class="div2">
			...
			<div class="div3">
				...
				<li><a class="a" href="javascript:void(0);"
					onClick="openurl('uservideoQuery.html');">归还图书</a></li>
			...
			<a class="a1" href="http://localhost:8080/First/shouyedwnl1/showye.jsp"><div class="div2">
					<div class="tcht"></div>
					退出后台
				</div></a>
		</div>
