 ...
 * Generated at: 2019-12-15 07:14:01 UTC
...
public final class jieyueguize_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<h1>山东师范大学图书借阅系统管理规则</h1>\r\n");
      out.write("\t\t\t\t\t\t\t<p><span>发布时间：2019-07-10 19:03:56</span><span>阅读：2235</span></p>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"txt\">\r\n");
      out.write("\t\t\t\t\t\t\t<p>1、爱护图书馆的各种文献，文明借阅；爱护馆内各种家具和设备，严禁随意涂抹刻画和破坏设备。未经许可，禁止在馆内张贴或散发广告及其它宣传品。\r\n");
      out.write("\t\t                    </p>\r\n");
      out.write("\r\n");
      out.write("\t\t                    <p>2、书一经借出，中途不得转借他人。\r\n");
      out.write("\t\t                    </p>\r\n");
      out.write("\t\t                    <p>3、借书时要检查原书，如有污损、缺页等情况应及时说明。</p>\r\n");
      out.write("\t\t                    <p>4、借阅的书要爱护，不得撕页、折页、剪裁、折卷图书，不得在书上画线、批注或涂写，如有损坏或丢失要赔偿同样的新书或按照图书原价赔偿。</p>\r\n");
      out.write("\t\t\t\t\t\t<p>5、购买不到所丢图书，普通中文图书按原书价格的3-10倍赔偿。字词典、手册、珍本、外文原版图书，按原书价格10倍赔偿。</p>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
